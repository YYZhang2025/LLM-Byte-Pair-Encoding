...
from base_tokenizer import BasicTokenizer
...
test_strings = [
    ...
    "FILE:data/tw.txt",  # FILE: is handled as a special string in unpack()
]
...
@pytest.mark.parametrize(
    "tokenizer_factory", [BasicTokenizer, BPETokenizer, GPT4Tokenizer]
)
...
@pytest.mark.parametrize("tokenizer_factory", [BasicTokenizer, BPETokenizer])
